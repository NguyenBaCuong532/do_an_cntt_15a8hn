  ...
  return (
    <AdminLayout>
      <div className='qlpm-container '>
        <p className="text-center font-bold text-[2.75rem] py-[1.25rem]">Quản Lý Máy</p>
        <div className='table-search-m flex flex-col gap-2 mt-4'>
          <h2 className='form-search font-bold text-[1.35rem] py-[1.25rem]'>Thông Tin Phòng Máy</h2>
          <table>
            <tr>
              <td>
        ...
        <div className="table-cauhinh">
          <button className='form-tao'><Link to="/formqlm"><AddIcon className="!text-[#edf0ed] !w-7 !h-7 mr-1 mb-1"/>Tạo Mới</Link>
</button>
   ...
   <table>
            <tr>
             <button className='bg-gradient-to-r from-green-400 to-green-600 text-[#ffffff] 
               ...
               <VisibilityIcon className=' ml-5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg !w-8 !h-8 py-1'/></button>
            </tr>
            <tr>
