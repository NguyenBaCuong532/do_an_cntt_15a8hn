    ...
    <div className="admin-container1 ">
      ...
      <header className="side-nav1">
        <ul>
          ...
          <input
            className=" ml-[300px] w-[350px]"
            placeholder="Nhập nội dung tìm kiếm..."
          />
          <SearchIcon className=" ml-[-40px] text-[#4e545c]" />
        </ul>
      </header>
      <main className=" pl-[300px]">{props.children}</main>
      <footer>
        <div className="duoi">
          <h6>Trường Đại học Kinh tế - Kỹ thuật Công nghiệp</h6>
          <br />
          <div className=" text-center ">
            <a>Địa chỉ: 353 Trần Hưng Đạo, TP.Nam Định</a>
            <br />
            <a>456 Minh Khai, Hai Bà Trưng, Hà Nội</a>
            <br />
